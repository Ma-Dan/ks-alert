...
type AlertRule struct {
	...
	AlertRuleGroupId  string      `protobuf:"bytes,3,opt,name=alert_rule_group_id" json:"alert_rule_group_id,omitempty"`
	MetricName        string      `protobuf:"bytes,4,opt,name=metric_name" json:"metric_name,omitempty"`
	ConditionType     string      `protobuf:"bytes,5,opt,name=condition_type" json:"condition_type,omitempty"`
	PreferSeverity    bool        `protobuf:"varint,6,opt,name=prefer_severity" json:"prefer_severity,omitempty"`
	...
	Period            int32       `protobuf:"varint,9,opt,name=period" json:"period,omitempty"`
	ConsecutiveCount  int32       `protobuf:"varint,10,opt,name=consecutive_count" json:"consecutive_count,omitempty"`
	...
	SystemRule        bool        `protobuf:"varint,13,opt,name=system_rule" json:"system_rule,omitempty"`
	RepeatSend        *RepeatSend `protobuf:"bytes,14,opt,name=repeat_send" json:"repeat_send,omitempty"`
}
...
type AlertRuleGroupSpec struct {
	...
	ResourceTypeId string `protobuf:"bytes,2,opt,name=resource_type_id" json:"resource_type_id,omitempty"`
	SystemRule     bool   `protobuf:"varint,3,opt,name=system_rule" json:"system_rule,omitempty"`
}
...
type AlertRuleGroup struct {
	AlertRuleGroupId   string       `protobuf:"bytes,1,opt,name=alert_rule_group_id" json:"alert_rule_group_id,omitempty"`
	AlertRuleGroupName string       `protobuf:"bytes,2,opt,name=alert_rule_group_name" json:"alert_rule_group_name,omitempty"`
	Desc               string       `protobuf:"bytes,3,opt,name=desc" json:"desc,omitempty"`
	AlertRules         []*AlertRule `protobuf:"bytes,4,rep,name=alert_rules" json:"alert_rules,omitempty"`
	SystemRule         bool         `protobuf:"varint,5,opt,name=system_rule" json:"system_rule,omitempty"`
	ResourceTypeId     string       `protobuf:"bytes,6,opt,name=resource_type_id" json:"resource_type_id,omitempty"`
}
