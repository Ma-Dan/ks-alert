...
type SeveritySpec struct {
	SeverityId           string   `protobuf:"bytes,1,opt,name=severity_id,proto3" json:"severity_id,omitempty"`
...
type Severity struct {
	SeverityId           string   `protobuf:"bytes,1,opt,name=severity_id,proto3" json:"severity_id,omitempty"`
	SeverityCh           string   `protobuf:"bytes,2,opt,name=severity_ch,proto3" json:"severity_ch,omitempty"`
	SeverityEn           string   `protobuf:"bytes,3,opt,name=severity_en,proto3" json:"severity_en,omitempty"`
