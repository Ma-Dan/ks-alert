...
type AlertHistory struct {
	AlertHistoryId            string       `protobuf:"bytes,1,opt,name=alert_history_id,proto3" json:"alert_history_id,omitempty"`
	AlertConfigId             string       `protobuf:"bytes,2,opt,name=alert_config_id,proto3" json:"alert_config_id,omitempty"`
	AlertName                 string       `protobuf:"bytes,3,opt,name=alert_name,proto3" json:"alert_name,omitempty"`
	SeverityId                string       `protobuf:"bytes,4,opt,name=severity_id,proto3" json:"severity_id,omitempty"`
	SeverityCh                string       `protobuf:"bytes,5,opt,name=severity_ch,proto3" json:"severity_ch,omitempty"`
	ResourceGroupId           string       `protobuf:"bytes,6,opt,name=resource_group_id,proto3" json:"resource_group_id,omitempty"`
	ResourceGroupName         string       `protobuf:"bytes,7,opt,name=resource_group_name,proto3" json:"resource_group_name,omitempty"`
	ResourceTypeId            string       `protobuf:"bytes,8,opt,name=resource_type_id,proto3" json:"resource_type_id,omitempty"`
	ResourceType              string       `protobuf:"bytes,9,opt,name=resource_type,proto3" json:"resource_type,omitempty"`
	AlertedResource           string       `protobuf:"bytes,10,opt,name=alerted_resource,proto3" json:"alerted_resource,omitempty"`
	ReceiverGroupId           string       `protobuf:"bytes,11,opt,name=receiver_group_id,proto3" json:"receiver_group_id,omitempty"`
	ReceiverGroupName         string       `protobuf:"bytes,12,opt,name=receiver_group_name,proto3" json:"receiver_group_name,omitempty"`
	Receivers                 []*Receiver  `protobuf:"bytes,13,rep,name=receivers,proto3" json:"receivers,omitempty"`
	AlertRuleGroupId          string       `protobuf:"bytes,14,opt,name=alert_rule_group_id,proto3" json:"alert_rule_group_id,omitempty"`
	TriggerAlertRule          string       `protobuf:"bytes,15,opt,name=trigger_alert_rule,proto3" json:"trigger_alert_rule,omitempty"`
	AlertRules                []*AlertRule `protobuf:"bytes,16,rep,name=alert_rules,proto3" json:"alert_rules,omitempty"`
	RepeatSend                *RepeatSend  `protobuf:"bytes,17,opt,name=repeat_send,proto3" json:"repeat_send,omitempty"`
	RequestNotificationStatus string       `protobuf:"bytes,18,opt,name=request_notification_status,proto3" json:"request_notification_status,omitempty"`
	EventTime                 string       `protobuf:"bytes,19,opt,name=event_time,proto3" json:"event_time,omitempty"`
...
type AlertHistoryRequest struct {
	...
	ResourceId           string   `protobuf:"bytes,4,opt,name=resource_id,proto3" json:"resource_id,omitempty"`
	...
	StartTime            int64    `protobuf:"varint,10,opt,name=start_time,proto3" json:"start_time,omitempty"`
	EndTime              int64    `protobuf:"varint,11,opt,name=end_time,proto3" json:"end_time,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
type AlertHistoryResponse struct {
	AlertHistory         []*AlertHistory `protobuf:"bytes,1,rep,name=alert_history,proto3" json:"alert_history,omitempty"`
