...
type ResourceGroup struct {
	ResourceGroupId      string            `protobuf:"bytes,1,opt,name=resource_group_id,proto3" json:"resource_group_id,omitempty"`
	ResourceGroupName    string            `protobuf:"bytes,2,opt,name=resource_group_name,proto3" json:"resource_group_name,omitempty"`
	ResourceUriTmpls     *ResourceUriTmpls `protobuf:"bytes,3,opt,name=resource_uri_tmpls,proto3" json:"resource_uri_tmpls,omitempty"`
	Desc                 string            `protobuf:"bytes,4,opt,name=desc,proto3" json:"desc,omitempty"`
	ResourceTypeId       string            `protobuf:"bytes,5,opt,name=resource_type_id,proto3" json:"resource_type_id,omitempty"`
...
type Resource struct {
	ResourceId           string   `protobuf:"bytes,1,opt,name=resource_id,proto3" json:"resource_id,omitempty"`
	ResourceName         string   `protobuf:"bytes,2,opt,name=resource_name,proto3" json:"resource_name,omitempty"`
	ResourceGroupId      string   `protobuf:"bytes,3,opt,name=resource_group_id,proto3" json:"resource_group_id,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
type ResourceGroupResponse struct {
	ResourceGroup        *ResourceGroup `protobuf:"bytes,1,opt,name=resource_group,proto3" json:"resource_group,omitempty"`
